               ...
               <table align='center' cellspacing=2 cellpadding=5 class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border=1>
                <thead>
                  ...
                  <tr id="row1">            
                    ...
                    <input type="submit" value="Save" class="btn btn-success fa" class="save btn-success fa">
                    <hr>
                    <a name="cancel" id="cancel" href="{{route('ParkingArea.update',['id'=>$parking_area->id])}}" class="btn btn-success fa" class="cancel btn-success fa">cancel</a>
