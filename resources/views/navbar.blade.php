      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="/">
            <i class="fa fa-fw fa-dashboard" style="color: #28a745;"></i>
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
              <a class="nav-link" href="users.php">
                <i class="fa fa-fw fa-user" style="color: #28a745;"></i>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
              <a class="nav-link" href="{{route('Owner.index')}}">
                <i class="fa fa-fw fa-users" style="color: #28a745;"></i>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
              <a class="nav-link" href="{{route('ParkingArea.index')}}">
                <i class="fa fa-fw fa-car" style="color: #28a745;"></i>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
              <a class="nav-link" href="{{ route('Card.index') }}">
                <i class="fa fa-fw fa-address-card" style="color: #28a745;"></i>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Link">
          <a class="nav-link" href="#">
            <i class="fa fa-fw fa-link"  style="color: #28a745;"></i>
      ...
      <ul class="navbar-nav sidenav-toggler"style="background: #343a40;">
        <li class="nav-item">
          <a class="nav-link text-center" id="sidenavToggler">
            <i class="fa fa-fw fa-angle-left "  style="color:#ffc107;"></i>
          </a>
        </li>
      </ul>
    </div>
